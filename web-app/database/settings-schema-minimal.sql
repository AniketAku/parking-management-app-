-- ===================================================================
-- MINIMAL SETTINGS MANAGEMENT SYSTEM - WORKING VERSION
-- Simplified to avoid trigger issues, focus on core functionality
-- ===================================================================
...
-- Simplified settings history without complex triggers
...
-- Simple function to get setting value with hierarchy resolution
...
COMMENT ON TABLE location_settings IS 'Location-specific setting overrides';
