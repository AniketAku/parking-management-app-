-- =============================================================================
-- SHIFT MANAGEMENT SYSTEM - DATABASE SCHEMA MIGRATION
...
COMMENT ON CONSTRAINT idx_single_active_shift ON shift_sessions IS 'Ensures business rule: only one active shift allowed at any time';